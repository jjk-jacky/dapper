...
Keys are case sensitive. Spaces can be used before/after the equal sign. Empty lines and lines starting
with a # will be ignored, the later allowing to add comments.
...
L<https://bitbucket.org/jjacky/dapper>
